...
class Notepad(QMainWindow):
    ...
    def reading_settings(self):
        ...
        if "True" == wrap_mode:
            ...
            self.autoWrapAction.setIcon(QIcon(icon_list['check_no']))
    ...
    def display_find_dialog(self):
        ...
        button_box.addButton(self.findButton, QDialogButtonBox.ActionRole)
    ...
    def set_wrap(self):
        ...
        if 1 == mode:
            ...
            self.autoWrapAction.setIcon(QIcon(icon_list['check']))
    ...
    def toggle_toolbar(self):
        if self.toolBar.isHidden():
            self.toolBar.show()
            self.toolBarAction.setIcon(QIcon(icon_list['check']))
        else:
            self.toolBar.hide()
            self.toolBarAction.setIcon(QIcon(icon_list['check_no']))
